...
export const metadata: Metadata = {
  title: "Zogreo | Raising Skilled Minds. Building Better Futures.",
  description: "Accredited certificate, diploma and advanced diploma programs in ICT, Business and Finance in Nairobi, Kenya. Apply online today.",
};
...
export default function HomePage() {
  return (
    <div className="flex flex-col">
      {/* Hero */}
      <section className="bg-navy text-white px-6 py-20 md:py-36">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-display font-semibold leading-tight mb-6">
            Raising Skilled Minds.<br />Building Better Futures.
          </h1>
          <p className="text-lg md:text-xl text-gold-soft/90 mb-10 max-w-2xl mx-auto leading-relaxed">
            Accredited professional programs in ICT, Business, and Finance — designed for careers that matter in East Africa and beyond.
          </p>
